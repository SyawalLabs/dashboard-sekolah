...
($(document).ready(function () {
    ...
    $(document).ready(function () {
        new ApexCharts(document.querySelector("#income-bar-chart"), {
            chart: {
                type: "bar",
                height: 120,
                stacked: !0,
            ...
            plotOptions: {
                bar: { endingShape: "rounded", columnWidth: "20%" },
            },
            grid: { show: !1 },
            grid: {
    ...
    $(document).ready(function () {
        new ApexCharts(document.querySelector("#expense-bar-chart"), {
            chart: {
                type: "bar",
                height: 120,
                stacked: !0,
    ...
    $(document).ready(function () {
        new ApexCharts(document.querySelector("#order-bar-chart"), {
            chart: {
                type: "bar",
                height: 120,
                stacked: !0,
    ...
    $(document).ready(function () {
        new ApexCharts(document.querySelector("#total-sales-color-graph"), {
            ...
            series: [
                { name: "Total Sales", data: [20, 10, 18, 12, 25, 10, 20] },
            ],
            yaxis: { min: 0, max: 30 },
            tooltip: {
                theme: "dark",
    ...
    $(document).ready(function () {
        new ApexCharts(document.querySelector("#total-comment-color-graph"), {
            chart: { type: "area", height: 100, sparkline: { enabled: !0 } },
            dataLabels: { enabled: !1 },
            colors: ["#ff9999"],
            fill: { type: "solid", opacity: 0.4 },
            stroke: { curve: "smooth", width: 3 },
            series: [
                { name: "Total Comments", data: [10, 20, 18, 25, 12, 10, 20] },
            ],
            yaxis: { min: 0, max: 30 },
            tooltip: {
                theme: "dark",
    ...
    $(document).ready(function () {
        new ApexCharts(document.querySelector("#total-income-color-graph"), {
            chart: { type: "area", height: 100, sparkline: { enabled: !0 } },
            dataLabels: { enabled: !1 },
            colors: ["#64ffaa"],
            fill: { type: "solid", opacity: 0.4 },
            stroke: { curve: "smooth", width: 3 },
            series: [
                { name: "Income Status", data: [20, 10, 25, 18, 18, 10, 12] },
            ],
            yaxis: { min: 0, max: 30 },
            tooltip: {
                theme: "dark",
    ...
    $(document).ready(function () {
        new ApexCharts(document.querySelector("#total-visitors-color-graph"), {
            chart: { type: "area", height: 100, sparkline: { enabled: !0 } },
            dataLabels: { enabled: !1 },
            colors: ["#ffca7d"],
            fill: { type: "solid", opacity: 0.4 },
            stroke: { curve: "smooth", width: 3 },
            series: [
                { name: "Total Visitors", data: [18, 10, 20, 10, 12, 25, 20] },
            ],
            yaxis: { min: 0, max: 30 },
            tooltip: {
                theme: "dark",
    ...
    $(document).ready(function () {
        new ApexCharts(document.querySelector("#earnings-card-area-chart"), {
            series: [{ name: "Earnings", data: [25, 60, 20, 90, 45, 100, 55] }],
            chart: {
                type: "area",
                height: 130,
                toolbar: { show: !1 },
    ...
    $(document).ready(function () {
        new ApexCharts(document.querySelector("#expense-card-area-chart"), {
            series: [{ name: "Expenses", data: [25, 60, 20, 90, 45, 100, 55] }],
            chart: {
                type: "area",
                height: 130,
                toolbar: { show: !1 },
    ...
    $(document).ready(function () {
        new ApexCharts(document.querySelector("#revenue-card-area-chart"), {
            series: [{ name: "Revenue", data: [25, 60, 20, 90, 45, 100, 55] }],
            chart: {
                type: "area",
                height: 130,
                toolbar: { show: !1 },
    ...
    $(document).ready(function () {
        new ApexCharts(document.querySelector("#task-completed-area-chart"), {
            series: [
                { name: "Task Completed", data: [44, 55, 41, 60, 52, 66, 51] },
            ],
            chart: {
                type: "area",
                height: 100,
            ...
            stroke: { width: 0.5, curve: "smooth", dashArray: [2, 2, 2, 2] },
            fill: {
                type: "gradient",
                gradient: {
                    shadeIntensity: 1,
    ...
    $(document).ready(function () {
        new ApexCharts(document.querySelector("#new-tasks-area-chart"), {
            series: [{ name: "New Tasks", data: [44, 55, 41, 60, 52, 66, 51] }],
            chart: {
                type: "area",
                height: 100,
                toolbar: { show: !1 },
    ...
    $(document).ready(function () {
        new ApexCharts(document.querySelector("#project-done-area-chart"), {
            series: [
                { name: "Project Done", data: [44, 55, 41, 60, 52, 66, 51] },
            ],
            chart: {
                type: "area",
                height: 100,
    ...
    $(document).ready(function () {
        new ApexCharts(document.querySelector("#billable-time-bar-chart"), {
            ...
            series: [
                {
                    name: "Perempuan",
                    data: [13, 15, 15, 12, 10, 12, 15, 13, 11, 16, 12, 15],
                },
                {
                    name: "Laki-laki",
                    data: [15, 10, 12, 10, 16, 12, 12, 12, 15, 10, 13, 11],
                },
            ],
            markers: { size: 0 },
            xaxis: {
    ...
    $(document).ready(function () {
        new ApexCharts(document.querySelector("#leads-overview-donut"), {
            ...
            legend: {
                ...
                fontFamily: "Inter",
                fontWeight: 500,
                labels: { colors: "#A0ACBB", fontFamily: "Inter" },
            ...
            responsive: [
                {
                    breakpoint: 380,
                    options: { chart: { width: 280 }, legend: { show: !1 } },
                },
            ],
            tooltip: {
                y: {
    ...
    $(document).ready(function () {
        new ApexCharts(document.querySelector("#click-by-country-donut"), {
    ...
    $(document).ready(function () {
        new ApexCharts(document.querySelector("#websitean-alytics-bar-chart"), {
    ...
    $(document).ready(function () {
        new ApexCharts(document.querySelector("#billed-area-chart"), {
            chart: {
                height: 262,
                type: "area",
                stacked: !1,
    ...
    $(document).ready(function () {
        ...
        new ApexCharts(document.querySelector("#leads-bar-chart"), e).render();
    }),
    $(document).ready(function () {
        var e = {
            chart: {
        ...
        new ApexCharts(
            document.querySelector("#proposal-bar-chart"),
            e,
        ).render();
    }),
    $(document).ready(function () {
        ...
        new ApexCharts(
            document.querySelector("#contract-bar-chart"),
            e,
        ).render();
    }),
    $(document).ready(function () {
        ...
        new ApexCharts(
            document.querySelector("#project-bar-chart"),
            e,
        ).render();
    }),
    $(document).ready(function () {
        new ApexCharts(document.querySelector("#session-device-donut"), {
    ...
    $(document).ready(function () {
        var e = {
            ...
            series: [
                { name: "Spent", data: [200, 300, 400, 500, 460, 420, 380] },
            ],
            markers: { size: 0 },
            xaxis: {
        ...
        new ApexCharts(
            document.querySelector("#weekly-time-spent-chart"),
            e,
        ).render();
    }),
    $(document).ready(function () {
        new ApexCharts(document.querySelector("#visitors-area-chart"), {
            series: [
                {
                    name: "New Visitors",
                    data: [18, 21, 40, 28, 31, 47, 51, 32, 45, 36, 65, 26],
                },
                {
                    name: "Retuning Visitors",
                    data: [30, 11, 23, 18, 32, 30, 36, 15, 58, 45, 22, 34],
                },
            ],
    ...
    $(document).ready(function () {
        new ApexCharts(document.querySelector("#top-countries-bar-chart"), {
            chart: {
                type: "bar",
                height: 400,
                fontFamily: "inherit",
    ...
    $(document).ready(function () {
        new ApexCharts(document.querySelector("#earning-expense-area-chart"), {
            series: [
                {
                    name: "Earning",
                    data: [
            ...
            plotOptions: {
                bar: { endingShape: "rounded", columnWidth: "15%" },
            },
            colors: ["#3454D1", "#FFA21D"],
            dataLabels: { enabled: !1 },
            ...
            xaxis: {
                ...
                axisBorder: { show: !1 },
                axisTicks: { show: !1 },
                labels: { style: { colors: "#A0ACBB", fontFamily: "Inter" } },
            },
            yaxis: {
                labels: {
                    formatter: function (e) {
    ...
    $(document).ready(function () {
        var e = {
            chart: { toolbar: { show: !1 }, height: 500, type: "candlestick" },
            plotOptions: {
                candlestick: {
                    colors: { upward: "#3454d1", downward: "#e49e3d" },
                },
            },
            fill: { opacity: 0.9, colors: ["#25b865"] },
            series: [
                {
                    data: [
                        {
        ...
        new ApexCharts(
            document.querySelector("#performance-overview-candlestick-chart"),
            e,
        ).render();
    }));
